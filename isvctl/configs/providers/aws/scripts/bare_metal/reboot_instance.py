...
def main() -> int:
    ...
    try:
        ...
        # Capture post-reboot uptime — affirmative reboot proof. An absent
        # reboot_confirmed used to be treated as success by the validator;
        # always emit an explicit bool so the validator has a True to check.
